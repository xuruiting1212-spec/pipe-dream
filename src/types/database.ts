export interface Database {
  public: {
    Tables: {
      ...
      profiles: { Row:{id:string;user_id:string|null;profile_type:string;name:string;bio:string;avatar_url:string|null;cover_url:string|null}; Insert:{id?:string;user_id?:string|null;profile_type?:string;name?:string;bio?:string;avatar_url?:string|null;cover_url?:string|null}; Update:{name?:string;bio?:string;avatar_url?:string|null;cover_url?:string|null;profile_type?:string}; Relationships:[] }
