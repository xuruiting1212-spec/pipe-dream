...
const router = createRouter({
  ...
  routes: [
    { path: '/', name: 'home', component: () => import('@/views/HomeView.vue'), meta: { title: 'Pipe Dream — 首页' } },
    { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { title: '登录 — Pipe Dream' } },
    { path: '/post/:id', name: 'post-detail', component: () => import('@/views/PostDetail.vue'), meta: { title: '帖子详情 — Pipe Dream' } },
    { path: '/publish', name: 'publish', component: () => import('@/views/PublishView.vue'), meta: { title: '发布新帖 — Pipe Dream', requiresAuth: true } },
    { path: '/publish/:id', name: 'edit-post', component: () => import('@/views/PublishView.vue'), meta: { title: '编辑帖子 — Pipe Dream', requiresAuth: true } },
